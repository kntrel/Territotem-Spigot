...
public class MockServer implements Server {
    ...
    @Override public int getMaxWorldSize() {
        return 0;
    }
    ...
    @Override public boolean isLoggingIPs() {
        return false;
    }
    @Override public @NonNull List<String> getInitialEnabledPacks() {
        return Collections.emptyList();
    }
    @Override @NonNull public List<String> getInitialDisabledPacks() {
        return Collections.emptyList();
    }

    @Override public DataPackManager getDataPackManager() {
        return mock(DataPackManager.class);
    }
    @Override public ServerTickManager getServerTickManager() {
        return mock(ServerTickManager.class);
    }
