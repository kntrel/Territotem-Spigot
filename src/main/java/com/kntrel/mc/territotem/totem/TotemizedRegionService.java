...
public class TotemizedRegionService implements Listener {

    //CONSTANTS
    private static final Logger LOGGER = LoggerFactory.getLogger(TotemizedRegionService.class);
    ...
    //CONSTRUCTOR
    public TotemizedRegionService(Plugin plugin) {
        this.plugin_ = plugin;
    ...
    private void scheduleAudit(ChunkKey chunkKey) {
        ...
        this.plugin_.getServer().getScheduler().runTaskLater(this.plugin_, () -> this.processChunk(chunkKey), 2);
    }
