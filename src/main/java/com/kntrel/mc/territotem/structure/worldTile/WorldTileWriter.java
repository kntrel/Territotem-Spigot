...
public interface WorldTileWriter extends WorldTile {
    ...
    //DEFAULTS
    default void setBlock(Material material) { this.setBlock(material, this.blockState(), null); }
    default void setBlock(Material material, StateMap state) { this.setBlock(material, state, null); }
    default void editBlock(NBTCompound nbt) { this.setBlock(this.blockType(), this.blockState(), nbt); }
